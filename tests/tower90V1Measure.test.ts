...
import { TOWER90_RUSH_FOCUS, TOWER90_RUSH_V1, TOWER90_SAFE_FOCUS, TOWER90_SAFE_V1 } from "../tools/battleLab/scenarios/tower90v1.js";

const mean = (xs: number[]) => xs.length ? xs.reduce((a, b) => a + b, 0) / xs.length : 0;

describe("90階V1 6000戦の一時測定", () => {
  it("安全処理3順+速攻3順を各1000戦", () => {
    const rows = [
      ...TOWER90_SAFE_FOCUS.map((focus, i) => ({ type: "SAFE", focus, scenario: TOWER90_SAFE_V1, seed: 20260990 + i * 10_000 })),
      ...TOWER90_RUSH_FOCUS.map((focus, i) => ({ type: "RUSH", focus, scenario: TOWER90_RUSH_V1, seed: 20270990 + i * 10_000 })),
