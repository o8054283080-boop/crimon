 ...
 * (呪晶→速度+75 / 魔晶→攻撃+1250)だけが v1 との違い。
 *
  ...
  enemies: [
    {
      ...V1_BOSS,
      label: "古代の豪魔人",
      stats: { ...V1_BOSS.stats, hp: 150_000, atk: 6_800 },
      skills: BOSS_SKILLS,
      bossTraits: {
    ...
    },
    {
      ...
      bossTraits: { empowerBossOnDeath: { spd: 75 } },
    },
  ],
