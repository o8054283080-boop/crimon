 ...
 * (呪晶→速度+85 / 魔晶→攻撃+1,600)だけが v1 との違い。
 *
...
export const TOWER60_V2: Scenario = {
  ...
  enemies: [
    ...
    },
    {
      ...
      bossTraits: { empowerBossOnDeath: { spd: 85 } },
    },
  ],
  /*
   ...
   *
   * この階では「取り巻きを倒すと本体が伸びる」ので、
   * **倒さずに本体だけ削る**のが最良手になった(85.7%)。
   * v1(取り込みなし)では逆にAIまかせが最良だったので、
   * **階ごとに測って並べ直すこと。**
   */
  focusPatterns: [
