-- =====================================================================
-- 【流さないこと】このファイルは本番に一度も流れていない(2026-09-25 に読み取りで確認)。
-- 後から流すと、`20260926090000_arena_rebalance_2026_09.sql` のレート式と
-- 防衛の設定(0.5・防衛コイン)を古い v2 で上書きしてしまう。
-- 誤って流しても何も変わらないよう、先頭で止める。中身は経緯のために残す。
-- =====================================================================
do $$
begin
  raise exception 'SUPERSEDED: 20260926090000_arena_rebalance_2026_09.sql を使うこと';
end
$$;
