...
export const COMPENSATIONS: Compensation[] = [
  ...
  },
  {
    ...
    title: "9/2 第5〜8章 報酬・難易度アップデート",
    message: "第5〜8章の経験値・ゴールド・装備・モンスタードロップを見直し、後半の章ほど周回報酬が増えるようにしました。第8章の獲得経験値はNORMALで15,000、HARDで22,500、HELLで30,000です。通常ステージの装備は最大★5とし、★6装備はこれまでどおり装備ダンジョンで狙う設計にしています。各章のボスステージでは★3転生ピッグもまれに獲得できます。あわせて8-5 HELLの敵を、育成した編成で周回できる範囲に調整しました。",
