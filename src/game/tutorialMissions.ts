...
export interface TutorialReward { gold?: number; crystal?: number; summonScrolls?: number }
...
export const TUTORIAL_MISSIONS: readonly TutorialMission[] = [
  ...
  m(10,2,"初めての装備強化","強化値+1以上の装備を所持",{gold:15000,crystal:30},"EQUIPMENT",p=>enhanced(p,1)),
  ...
  m(15,3,"初めての★4","★4以上のモンスターを所持",{gold:50000,crystal:80,summonScrolls:2},"MONSTERS",p=>maxStar(p,4)),
  ...
  m(20,4,"初めての★5","★5以上のモンスターを所持",{gold:80000,crystal:120,summonScrolls:3},"MONSTERS",p=>maxStar(p,5)),
  ...
  m(25,4,"基本育成卒業・★6","★6モンスターを所持",{gold:200000,crystal:300,summonScrolls:5},"MONSTERS",p=>maxStar(p,6)),
  ...
  m(30,5,"ロードマップ制覇","タイプ転生済み★6に能力ポイントを使用",{gold:150000,crystal:200,summonScrolls:5},"MONSTER_CREATE",p=>p.monsters.some(x=>x.star===6&&x.development.type!==null&&Object.values(x.development.abilityPoints).some(v=>v>0))),
];
