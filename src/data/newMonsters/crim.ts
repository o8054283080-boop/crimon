...
const fromStar6Lv60 = (value: number): number => value / STAR6_LV60_MULTIPLIER;
 ...
 * 攻撃が通らなかった時ほど守りが要る。
 *
 * ターン数はLvで伸ばさない(`fixedDuration`)。2ターンの守りを
 * 3ターンにするとPvEの難所が別物になる。伸ばすのは量とクールタイムだけ。
 */
const CRIM_S3: Skill = {
  id: "crim_s3",
  name: "創世の宝珠",
...
export const CRIM: MonsterTemplate = {
...
export const CRIM_TEMPLATES: MonsterTemplate[] = [CRIM];
