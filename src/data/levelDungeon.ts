 ...
 *
 * **1日3回まで**。回数を絞る代わりに1回の実入りを大きくしてある。
 ...
 * 1日に挑める回数。
 *
 * ゴールドダンジョンと同じ3回。**同じ数にしてあるのは偶然ではない。**
 * どちらも「1日ぶんの実入りが決まっている場所」で、
 * 数が違うと片方だけを覚えなければならなくなる。
 */
export const LEVEL_DUNGEON_DAILY_LIMIT = 3;
 ...
 * 5階を1日3回まわすと 1体あたり 156,000 なので、**最上階に通い詰めて約3日**で1体が仕上がる。
 ...
 * ここは腕試しの場所ではなく育てるために通う場所で、しかも1日3回しかない。
