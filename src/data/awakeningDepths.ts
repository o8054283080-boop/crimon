...
const FLOOR_CONFIG: Record<number, FloorConfig> = {
  1: {
    ...
    counterAfterHits: 0, adaptationMax: 0, shards: [], stamina: 10,
  ...
  2: {
    ...
    counterAfterHits: 0, adaptationMax: 0, shards: ["ATK"], stamina: 10,
  ...
  3: {
    ...
    counterAfterHits: 0, adaptationMax: 0, shards: ["DEF"], stamina: 10,
  ...
  4: {
    ...
    counterAfterHits: 0, adaptationMax: 0, shards: ["ATK", "DEF"], stamina: 10,
  ...
  7: {
    ...
    counterAfterHits: 7, adaptationMax: 0.10, shards: ["ATK", "DEF"], stamina: 10,
