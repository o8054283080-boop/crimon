...
const SCREENS = new Set<ScreenName>([
  ...
  "GOLD_DUNGEON_BATTLE", "MONSTER_DEX", "SKILL_DEX", "MONSTER_EXCHANGE", "MONSTER_STORAGE", "SHOP", "MONSTER_TRAINING", "MONSTER_CREATE",
  "AUTO_FARM_RESULT", "ARENA", "ARENA_BATTLE", "TRIAL_TOWER", "TOWER_BATTLE", "HOW_TO_PLAY", "RANKINGS",
]);
