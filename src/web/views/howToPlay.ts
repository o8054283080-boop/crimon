...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "**育成ダンジョン**: 経験値だけを集める場所。1日5回まで。その代わり1回の実入りが大きい",
  ...
  },
  {
    name: "tower",
    title: "試練の塔",
    lead: "ここだけ、階と階の間で何も回復しません。積み上げた育成がそのまま試される場所です。",
    points: [
      "**HPとクールタイムを次の階へ持ち越します。**強い技を撃った次の階は、その技が使えません",
      "**倒れた仲間は節(10階ごと)まで戻りません。**削られずに勝つことが、そのまま先へ進む力になります",
      "節を越えると全回復し、次はそこから再開できます。力尽きても節までの到達は消えません",
      "階ごとに敵の性質が変わります。癒やす敵・盾を張る敵・数で来る敵・速い敵と、要る手が変わります",
      "塔の編成は他とは別枠です。粘れる顔ぶれに組み替えてください",
    ],
  },
  {
    name: "stamina",
    ...
    points: [
      ...
      "育成ダンジョンとゴールドダンジョンには、1日の回数制限があります(日付が変わると戻ります)",
    ],
  },
];
